...
export const encodeDiagram = `flowchart LR
  subgraph json["JSON on the wire"]
    j["{#quot;id#quot;:1,#quot;name#quot;:#quot;Ada#quot;,#quot;email#quot;:#quot;a@x.io#quot;}<br/>— keys repeated as text"]
  end
  subgraph pb["Protobuf on the wire"]
    p["[1→1][2→Ada][3→a@x.io]<br/>— numbered tags + binary values"]
  end`;
