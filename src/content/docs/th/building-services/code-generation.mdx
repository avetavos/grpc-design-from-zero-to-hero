...
export const quizGen = [
  {
    q: 'protoc กับ plugin ของตัวเองมีบทบาทต่างกันอย่างไร?',
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      'ไม่ต้องทำอะไร — generated code update ตัวเองตอน runtime',
    ],
    answer: 1,
  },
  {
    ...
    options: [
      'ทำให้ protobuf อ่านออกด้วยตาเปล่า',
      'แทนคำสั่งหลาย plugin ที่เปราะด้วยคำสั่งเดียวที่ขับด้วย config พร้อม lint และตรวจ breaking change',
      'ตัดความจำเป็นของ .proto ออกไป',
      'ใช้ได้กับ Go เท่านั้น',
    ],
    answer: 1,
  },
];
