...
- **ลบ field** — *ตราบใดที่คุณ `reserved` number นั้นไว้* (ดูด้านล่าง) client เก่าที่ยังส่งมาก็ถูกข้ามไปเฉย ๆ
...
export const quizEvolve = [
  ...
  },
  {
    ...
    options: [
      'ทำให้ encode ช้าลง',
      'client เก่ายังส่ง number นั้นอยู่ bytes เดิมเลยโดน decode เป็น field ใหม่ — ข้อมูลเสียแบบเงียบ',
      'compiler ปฏิเสธการ build',
      'พังแค่ documentation',
    ],
    answer: 1,
  },
  {
