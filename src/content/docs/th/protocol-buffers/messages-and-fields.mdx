...
ให้ number ต่ำ (1–15) กับ field ที่ hot และมีอยู่เสมอ เมื่อ number ถูก assign และปล่อยออกไปแล้ว ให้ถือว่าถาวร — value ที่ชี้ตอนนี้เป็นส่วนหนึ่งของ wire contract ของคุณแล้ว
</Callout>
...
message คือ field ที่มี type และตัวตนจริงของแต่ละ field คือ **number** ไม่ใช่ชื่อ number ทำให้ message กะทัดรัดและ rename ได้ฟรี — แต่ก็แปลว่า number เป็นของถาวร ให้ field ที่ hot ใช้ number byte เดียว 1–15 และเมื่อลบ field ให้ `reserved` number ของตัวเองไว้ตลอดกาล
</Callout>
