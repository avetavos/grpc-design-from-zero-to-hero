---
title: 'Metadata'
description: 'header และ trailer แบบ key/value ที่เดินทางไปพร้อม call — auth token, trace id, request id — วิธีอ่านและเขียน และวิธีที่ metadata propagate'
sidebar:
  order: 4
---
...
export const quizMd = [
  ...
  },
  {
    ...
    options: [
      ...
      'value ของตัวเองถูกมองเป็น raw bytes และ base64-encode บน wire',
      'ถูกบีบอัดสองครั้ง',
  ...
  },
  {
    ...
    options: [
      ...
      'database เป็นตัว join trace ให้',
      'ถูกเก็บใน .proto',
    ],
    answer: 1,
  },
