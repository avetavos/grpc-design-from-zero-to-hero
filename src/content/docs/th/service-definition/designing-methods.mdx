...
description: 'wrapper request/response message, convention การตั้งชื่อ, pagination และ idempotency — นิสัยที่ทำให้ API แข็งแรงเมื่อโตขึ้น'
sidebar:
  order: 4
---
