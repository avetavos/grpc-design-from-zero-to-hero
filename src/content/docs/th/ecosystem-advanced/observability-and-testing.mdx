...
export const quizObs = [
  ...
  },
  {
    ...
    options: [
      'ข้าม serialization ไปเลย',
      'ใช้เส้นทาง server, client และ interceptor จริง โดยไม่มี network ที่ช้าและ flaky',
      'เป็นวิธีเดียวที่ test streaming ได้',
      'ไม่ต้องใช้ `.proto`',
    ],
    answer: 1,
  },
  {
    ...
    options: [
      'เร็วกว่าอย่างมากในทุกกรณีเสมอ',
      'มักเร็วกว่าสำหรับ call ปริมาณสูงขนาดเล็กที่มีโครงสร้าง แต่ควร benchmark workload จริงของคุณ',
      'ช้ากว่าเสมอ',
